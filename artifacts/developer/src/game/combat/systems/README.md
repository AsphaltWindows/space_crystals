...
- `core.rs` — Core combat systems: attack command processing, attack phase progression, auto-targeting, idle leash, damage application, dead entity removal, attack channel sync (BaseAttackChannel + cross-channel constraints), turret engagement (TurretAttackChannel + TurretOrientationChannel)
